...
contextBridge.exposeInMainWorld("webPilotDesktop", {
    ...
    deleteRun: (runId) => ipcRenderer.invoke("desktop:runs:delete", runId),
    ...
    deleteThread: (threadId) => ipcRenderer.invoke("desktop:threads:delete", threadId),
    clearHistory: () => ipcRenderer.invoke("desktop:history:clear"),
